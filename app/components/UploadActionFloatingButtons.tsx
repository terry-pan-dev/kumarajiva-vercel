...
import { SutraListDialog } from './SutraListDialog';
import { Button, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from './ui';

export default function UploadActionFloatingButtons({ teams, sutras }: { teams: ReadTeam[]; sutras: ReadSutra[] }) {
          ...
          {isExpanded && (
            <div className="absolute bottom-16 right-0 flex flex-col-reverse items-center gap-3">
              {[
                ...
                { modal: createSutraButton, tooltip: 'Create Sutra' },
